...
/* Module Version: 5.7 */
/* /home/vlad/Aux/FPGA/lattice/ispfpga/bin/lin64/scuba -w -n pll -lang verilog -synth lse -arch mg5a00 -type pll -fin 45 -phase_cntl STATIC -fclkop 180 -fclkop_tol 1.0 -fb_mode INTERNAL -noclkos -noclkok -norst -noclkok2  */
/* Sun Jul 20 02:38:27 2025 */
...
module pll (CLK, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    ...
    EPLLD1 PLLInst_0 (.CLKI(CLK), .CLKFB(CLKFB_t), .RST(scuba_vlo), .RSTK(scuba_vlo), 
        ...
        .CLKOK(), .LOCK(LOCK), .CLKINTFB(CLKFB_t))
             ...
             /* synthesis FREQUENCY_PIN_CLKOP="180.000000" */
    ...
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 180.000000
